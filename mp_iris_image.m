function [I_ref, I_tot, I_scat] = mp_iris_image(scattered, reflected, micr, mediumIndex)
...
% 3. Get the reference fields at the sample points.
% It's a single plane wave, so we don't need to grid and integrate.
